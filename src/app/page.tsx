    ...
    <>
      <main>
        ...
        <section className={styles.inicio}>
            ...
            <br /><br /><br /><br />
            <div><a href="#" download="GabrielMartinezCV" className={styles.btncv}>
            Descargar CV </a></div>
        </section>
        <br /><br />
        <section className={styles.section}>
            <div className={styles.section_titulo}><h1>👨‍🏫Habilidades</h1></div><br /><br /><br />
            <div>    
        ...
        <div className={styles.section_titulo}><h1>📋Proyectos</h1></div><br /><br /><br />
