      ...
      <main>
        ...
        <div className={styles.proyecto_content}>
            ...
            <div className={styles.proyecto_descripcion}>
                <p>A través del análisis de encuestas a desarrolladores, este proyecto revela las herramientas y lenguajes más utilizados hoy y las tendencias emergentes que transformarán el panorama tecnológico.</p>    
            </div>
            
            <div className={styles.proyecto_botones}>
                <a href="https://github.com/Gab1nh0/IBM-Capstone-Project/blob/main/CapstoneProjectDashboard.pdf" target="_blank">Ver Dashboard <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 20 20"><path fill="currentColor" d="M17 17H3V3h5V1H3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5h-2z"/><path fill="currentColor" d="m11 1l3.29 3.29l-5.73 5.73l1.42 1.42l5.73-5.73L19 9V1z"/></svg></a>
                <a href="https://github.com/Gab1nh0/IBM-Capstone-Project/blob/main/Final-capstone-story-template.pdf" target="_blank">Ver Análisis <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 20 20"><path fill="currentColor" d="M17 17H3V3h5V1H3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5h-2z"/><path fill="currentColor" d="m11 1l3.29 3.29l-5.73 5.73l1.42 1.42l5.73-5.73L19 9V1z"/></svg></a>
            
            </div>
        </div><br /><br />
        <div className={styles.proyecto_content_img}>
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246961/zkysl0dsvttuzrho09ow.png" alt="" />
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246961/xgzpb2gyv7roxlwtxblt.png" alt="" />
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246961/wgmq29jabfufyiwouvvc.png" alt="" />
        </div>
        ...
        <div className={styles.proyecto_content}>
            ...
            <div className={styles.proyecto_descripcion}>
                <p>App para aprender sobre el cuerpo humano con este interactivo drag & drop diseñado para niños. Aprendiendo cómo funciona el sistema digestivo mientras colocamos los órganos en su lugar. Educación y diversión para niños</p>
            </div>
        ...
        <div className={styles.proyecto_content_img}>
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246548/d3iiaspuyzklcrq7o4s1.jpg" alt="" />
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246548/ruir4sm9xo9l9ka0myho.jpg" alt="" />
            <img className={styles.img} src="https://res.cloudinary.com/dnvwjkcpj/image/upload/v1737246548/ncdo8id1fzqje54azn2e.jpg" alt="" />
        </div>
